...
function buildOfflinePublicProfile(surname) {
  const profiles = {
    "徐": {
      traditional: "徐",
      pinyin: "Xu",
      dynasty: "周代",
      ancestor: "徐若木、徐偃王等线索并存",
      junwang: "东海郡、高平郡等",
      tanghao: "东海堂、高平堂等",
      summary: "徐姓常见源流与嬴姓、古徐国相关，资料整理时可把徐国后裔、郡望发展和各地族谱线索并列呈现。",
      origins: [
        "嬴姓徐氏：常见说法把徐姓源流追溯到嬴姓徐国，徐国故地与今江苏、安徽一带的古徐文化线索相关，可信等级：常见典籍线索。",
        "徐国后裔：徐国灭亡后，国人或后裔以国为氏，是徐姓源流整理中的核心线索，可信等级：需与典籍原文互证。",
        "族谱分支：各地徐氏族谱常把郡望、堂号、迁徙祖和字辈结合叙述，应按地区分支分别归档，可信等级：族谱待核。"
      ],
      migrations: [
        "先秦/秦汉：古徐国及淮泗流域是徐姓早期叙述的重要空间，后续与东海郡望线索相连。",
        "魏晋南北朝：东海、高平等郡望线索逐渐进入谱牒叙述，部分家族随仕宦、避乱迁居。",
        "唐宋元明清：徐姓在江淮、江南、山东、江西、福建、广东等地形成多地分支，族谱和地方志材料较多。",
        "近现代：徐姓分布较广，可结合公开人口分布、宗亲资料和地方文史记录补充迁徙末端。"
      ],
      branches: [
        "东海徐氏：以东海郡望为重要标识，常见于徐姓郡望和堂号叙述。",
        "高平徐氏：高平郡望线索可与地方志、族谱资料交叉核对。",
        "江南徐氏：唐宋以后江南地区徐姓人物、宗族和地方志材料较丰富。",
        "闽粤徐氏：部分谱牒记录与迁徙、商贸、仕宦和移民路线相关。"
      ],
      figures: [
        "徐偃王：与古徐国传说和徐姓源流叙述关联度高，展示时应区分传说、典籍记载和后世附会。",
        "徐福：秦代方士相关故事流传广，需区分史书记载、地方传说和文化旅游叙事。",
        "徐霞客：明代地理游记作家，可作为徐姓文化人物条目，资料相对容易核验。"
      ],
      family: [
        "家风材料可围绕徐氏族谱序文、宗祠楹联、地方志人物传中的修身、读书、义行线索整理。",
        "东海堂、高平堂等堂号资料可与宗祠、族谱和地方文史条目互证。"
      ],
      sources: [
        "《通志·氏族略》相关姓氏条目",
        "古徐国、东海郡、高平郡相关地方志和文史资料",
        "各地徐氏族谱、宗祠碑刻、堂号资料",
        "徐霞客等可核验历史人物资料"
      ],
      risks: [
        "徐若木、徐偃王、徐国后裔等线索应区分神话传说、典籍记载和谱牒说法。",
        "东海郡、高平郡等郡望不能直接替代具体家族来源。",
        "徐福等人物典故需要避免把民间传说写成确定史实。",
        "各地族谱迁徙祖不同，发布前应按地域和谱系范围标注。"
      ]
    }
  };
  return profiles[surname] || {
    ...
    pinyin: `${surname}姓读音`,
    dynasty: "古代至中古时期线索",
    ancestor: `${surname}姓始祖线索需按典籍与族谱并列核对`,
    junwang: `${surname}姓郡望线索`,
    tanghao: `${surname}姓堂号线索`,
    summary: `${surname}姓临时初稿会先按典籍、地方志、族谱和公开资料四类线索组织，管理员审核后再发布为正式档案。`,
    origins: [
      `典籍记载线索：检索正史、类书和姓氏专著中的${surname}姓条目，可信等级：待核。`,
      `地方志线索：按发源地、郡望地、迁居地检索府县志氏族、人物、祠庙章节，可信等级：待核。`,
      `族谱/民间说法：收集族谱序文、字辈、迁徙记和口述材料，并与公开典籍互证，可信等级：需复核。`
    ],
    migrations: [
      `先秦/秦汉：整理${surname}姓早期得姓地、封国地或郡望地线索。`,
      `魏晋南北朝：关注${surname}姓郡望形成、仕宦、避乱和南北迁徙资料。`,
      `唐宋元明清：按科举、军屯、商贸、移民实录和地方志人口流动线索整理。`,
      `近现代：结合公开人口分布、侨迁资料和地方文史记录补充分布变化。`
    ],
    branches: [
      `${surname}姓郡望分支：查郡望来源和代表人物，避免把同名地望直接当成定论。`,
      `${surname}姓堂号分支：整理堂号、宗祠和族谱中可互证的分支。`,
      `${surname}姓地域分支：按省府县和迁徙节点归纳，标明资料来源。`
    ],
    figures: [
      `${surname}姓历史人物：优先查正史、地方志人物传和权威工具书。`,
      `${surname}姓典故线索：区分历史事件、文学演义和民间传说。`,
      `${surname}姓当代资料：只采用公开可核验资料，避免个人隐私和无来源内容。`
    ],
    family: [
      `${surname}姓族谱家训：查族谱凡例、家训、祠规和谱序原文。`,
      `${surname}姓宗祠楹联：查地方文史、宗祠碑刻和楹联资料。`
    ],
    sources: [
      "《通志·氏族略》、地方志、姓氏辞典、族谱目录、宗祠碑刻、公开人口分布资料。",
      "补充原文摘录、版本信息、页码、出版信息或公开链接。"
    ],
    risks: [
...
function buildOfflinePublicAiDraft(surname) {
  const profile = buildOfflinePublicProfile(surname);
  return [
    "基础档案：",
    `- 简体：${surname}`,
    `- 繁体：${profile.traditional}`,
    `- 拼音：${profile.pinyin}`,
    `- 起源朝代线索：${profile.dynasty}`,
    `- 得姓始祖线索：${profile.ancestor}`,
    `- 郡望：${profile.junwang}`,
    `- 堂号：${profile.tanghao}`,
    "",
    `源流摘要：${profile.summary}`,
    "",
    "源流分支：",
    ...profile.origins.map(item => `- ${item}`),
    "",
    "迁徙路线：",
    ...profile.migrations.map(item => `- ${item}`),
    "",
    "望族分支：",
    ...profile.branches.map(item => `- ${item}`),
    "",
    "名人典故：",
    ...profile.figures.map(item => `- ${item}`),
    "",
    "家风家训：",
    ...profile.family.map(item => `- ${item}`),
    "",
    "参考来源：",
    ...profile.sources.map(item => `- ${item}`),
    "",
    "审核风险：",
