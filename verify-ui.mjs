...
expectOk("AI 初稿自动回填结构化分支", app.includes("function parseAiListSection") && app.includes("function parseAiOrigins") && app.includes("function parseAiMigrations") && app.includes("function parseAiFigures") && app.includes("data.origins = parsedOrigins") && app.includes("data.migrations = parsedMigrations") && app.includes("data.branches = parsedBranches") && app.includes("data.figures = parsedFigures") && app.includes("renderSurname(surname)") && app.includes("源流分支、迁徙路线等结构化内容已同步"));
